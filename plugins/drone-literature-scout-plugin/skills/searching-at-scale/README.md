...
Use when a user needs broad or exhaustive current-web research, enumeration of many options or sellers, multi-source price or availability comparison, platform-wide discovery, historical datasets, purchase research, or a source-backed report across any topic.
