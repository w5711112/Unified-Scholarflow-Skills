...
Use when creating, selecting, editing, or reviewing scientific visuals for slides, Obsidian knowledge notes, paper method diagrams, or paper data figures and tables, especially when semantic accuracy, geometry, statistics, layout, or Image2 prompting matters.
