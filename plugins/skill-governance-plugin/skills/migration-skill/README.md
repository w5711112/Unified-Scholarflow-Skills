...
Use when moving, rebuilding, adapting, or validating one or more skills across Codex, Claude Code, Kimi Code, or another Agent where plugin APIs, tools, paths, scheduling, or runtime capabilities may differ.
