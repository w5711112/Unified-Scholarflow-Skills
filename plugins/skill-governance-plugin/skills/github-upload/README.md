...
Use when preparing local Skills for GitHub by creating a privacy-clean copy, adding public README and dependency guidance, auditing the package, or publishing it after explicit confirmation.
