...
Use when a Skill, script, or tool has a real technical failure, a verified route must be reused, or a resolved failure needs owner-routed regression or promotion handling.
