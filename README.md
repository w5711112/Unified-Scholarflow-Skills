...
使用前请补自己的**检索主题、来源范围、路径和写作偏好**。默认配置带维护者个人习惯，克隆后可以改。
...
2. **自动颜色标注重点**  
   【用颜色区分**论文原述 / 自己的推断 / 待核验**，并在重点处加高亮，突出不同层面的技术路径，避免以后把自己的猜想当成原文结论。】
